 ...
 * CREATE THE DATABASE
 */
$pdoDatabase = new PDO('mysql:dbname=db;host=db', $databaseUser, $databasePassword);
$pdoDatabase->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$pdoDatabase->exec('CREATE DATABASE IF NOT EXISTS db');

/*
 * CREATE THE TABLE
 */
$pdo = new PDO('mysql:dbname=db;host=db', $databaseUser, $databasePassword);
