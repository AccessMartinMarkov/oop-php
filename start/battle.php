 ...
 */
$container = new Container($db_configuration);
...
if (!$ship1Id || !$ship2Id) {
    header('Location: /start/index.php?error=missing_data');
    die;
}
...
if (!$ship1 || !$ship2) {
    header('Location: /start/index.php?error=bad_ships');
    die;
}

if ($ship1Quantity <= 0 || $ship2Quantity <= 0) {
    header('Location: /start/index.php?error=bad_quantities');
    die;
}
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a href="/start"><p class="text-center"><i class="fa fa-undo"></i> Battle again</p></a>
